 ...
 */
$components = [
    [EventController::class, ['index', 'invitation', 'create', 'update', 'delete', 'followUp', 'collaborate', 'rating']],
];
 ...
 */
$accesses = [
    [Enum::DENY, User::ROLE_GUEST, EventController::class, ['index', 'invitation', 'create', 'update', 'delete', 'followUp', 'collaborate', 'rating']],
